		...
		{		
			...
			{		
				...
				if ($tax!=0){
					...
					$precio_iva=round((($precio_redondeado*$tax_rate)/100),2);
			...
			$content.="</ul><p class='important'>&copy; <a href='https://imacreste.com' target='_blank'>Diseño web</a> imacreste</p>";
						...
						<p>	
							<ol>								
								<li>
									...
									<strong><pre>[imacprestashop_productos_ws productos='2,8' idioma='0' show_idioma='1']</pre></strong>
									<ul>										
								...
								<strong><pre>[imacprestashop_categorias_ws idioma='0'  categoria_id='47' num_productos='9'  show_idioma='']</pre></strong>
								<li>
